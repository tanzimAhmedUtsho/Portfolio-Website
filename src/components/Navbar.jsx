  ...
  return (
    <div className='bg-gray-950 -mb-7 z-50 w-full py-3 fixed'>
        <div className='flex items-center justify-between max-w-7xl mx-auto px-4 md:px-0'>
            {/* Logo Section */}
<div>
    <a href="#"><img src={Logo} alt="Logo" className='w-[170px]' /></a>
</div>
{/* Menu Section */}
<nav className='hidden md:block'>
    <ul className='flex gap-7 text-xl items-center font-semibold text-white'>
        ...
        <a href="#contact"><button className='px-3 py-1 cursor-pointer rounded-md bg-blue-500 text-white flex items-center gap-1 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0__0_5px_#33CCCC,0_0_15PX_#33CCCC,0_0_30px_#33CCCC] shadow-blue-500 border-blue-400 border-2'>Contact <FaChevronRight/></button></a>
    </ul>
